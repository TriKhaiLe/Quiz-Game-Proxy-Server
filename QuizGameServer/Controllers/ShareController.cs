...
namespace QuizGameServer.Controllers
{
    ...
    public class ShareController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetShareHtml([FromRoute] string id, CancellationToken cancellationToken)
        {
            ...
            sb.AppendLine($"  <meta property=\"og:title\" content=\"Thử thách kiến thức của bạn về {topic}!\" />");
            sb.AppendLine($"  <meta property=\"og:description\" content=\"{previewQuestion.Question} Lựa chọn: {string.Join(", ", previewQuestion.Options)}\" />");
            ...
            sb.AppendLine($"  <meta property=\"twitter:title\" content=\"Thử thách kiến thức của bạn về {topic}!\" />");
            sb.AppendLine($"  <meta property=\"twitter:description\" content=\"{previewQuestion.Question} Lựa chọn: {string.Join(", ", previewQuestion.Options)}\" />");
